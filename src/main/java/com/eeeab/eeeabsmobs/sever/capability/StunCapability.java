    ...
    public static class StunCapabilityImp implements IStunCapability {
        ...
        public void onStart(LivingEntity entity) {
            if (entity != null) {
                ...
                if (entity instanceof Mob mob && mob.getTarget() != null) setPrevAttackTargetUUID(mob.getTarget().getUUID());
            }
        }
        ...
        public void onEnd(LivingEntity entity) {
            if (entity != null) {
                if (inStun) {
                    inStun = false;
                    if (entity instanceof Mob mob && getPrevAttackTargetUUID() != null) {
                        Player target = mob.level().getPlayerByUUID(getPrevAttackTargetUUID());
                        if (target != null && mob.getTarget() == null) mob.setTarget(target);
                    }
                }
            }
        }
