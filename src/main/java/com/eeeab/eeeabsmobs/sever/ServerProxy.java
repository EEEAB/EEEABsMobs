...
public class ServerProxy {
    ...
    public void initNetwork() {
        ...
        EEEABMobs.NETWORK.messageBuilder(ShowHintMessage.class, ID++).encoder(ShowHintMessage::serialize).decoder(ShowHintMessage::deserialize).consumerMainThread(ShowHintMessage::handle).add();
