...
public class ModDamageTypeProvider extends DamageTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(DamageTypeTags.BYPASSES_ARMOR).add(ModResourceKey.IMMORTAL_MAGIC, ModResourceKey.IGNORE_ARMOR_ATTACK);
        tag(DamageTypeTags.BYPASSES_SHIELD).add(ModResourceKey.IGNORE_SHIELD_ATTACK).remove(ModResourceKey.IMMORTAL_MAGIC);
