...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(BlockInit.BONE_BUSH.get());
        this.dropSelf(BlockInit.EROSION_OAK_LOG.get());
        this.dropSelf(BlockInit.EROSION_OAK_WOOD.get());
        this.dropSelf(BlockInit.STRIPPED_EROSION_OAK_LOG.get());
        this.dropSelf(BlockInit.STRIPPED_EROSION_OAK_WOOD.get());
        this.dropSelf(BlockInit.EROSION_OAK_SAPLING.get());
        this.dropSelf(BlockInit.EROSION_OAK_PLANKS.get());
        this.dropSelf(BlockInit.EROSION_OAK_STAIRS.get());
        this.dropSelf(BlockInit.EROSION_OAK_SLAB.get());
        this.dropSelf(BlockInit.EROSION_OAK_FENCE.get());
        this.dropSelf(BlockInit.EROSION_OAK_FENCE_GATE.get());
        this.dropSelf(BlockInit.EROSION_OAK_TRAPDOOR.get());
        this.dropSelf(BlockInit.EROSION_OAK_PRESSURE_PLATE.get());
        this.dropSelf(BlockInit.EROSION_OAK_BUTTON.get());
        ...
        this.add(BlockInit.EROSION_OAK_DOOR.get(), this::createDoorTable);
        ...
        this.add(BlockInit.BONE_BUSH.get(), (builder) -> createShearsDispatchTable(builder, this.applyExplosionDecay(builder, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))))));
        this.add(BlockInit.POTTED_BONE_BUSH.get(), createPotFlowerItemTable(BlockInit.BONE_BUSH.get()));
        this.add(BlockInit.EROSION_OAK_LEAVES.get(), createLeavesDrops(BlockInit.EROSION_OAK_LEAVES.get(), BlockInit.EROSION_OAK_SAPLING.get(), NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(BlockInit.EROSION_OAK_BERRY.get(), (builder) -> createShearsDispatchTable(builder, this.applyExplosionDecay(builder, LootItem.lootTableItem(BlockInit.EROSION_OAK_BERRY.get().asItem()).apply(SetItemCountFunction.setCount(UniformGenerator.between(1F, 3.0F))))));
    }
