...
public class ItemInit {
    ...
    public static final RegistryObject<Item> DEMOLISHER = ITEMS.register("demolisher", () -> new ItemDemolisher(new Item.Properties().tab(EMTabGroup.TABS).stacksTo(1).rarity(Rarity.RARE).fireResistant()));
    //唱片
    public static final RegistryObject<Item> GUARDIANS_MUSIC_DISC = ITEMS.register("guardians_music_disc", () -> new RecordItem(8, SoundInit.GUARDIANS, new Item.Properties().tab(EMTabGroup.TABS).stacksTo(1).rarity(Rarity.RARE).fireResistant(), 3640));
    public static final RegistryObject<Item> THE_ARMY_OF_MINOTAUR_MUSIC_DISC = ITEMS.register("the_army_of_minotaur_music_disc", () -> new RecordItem(8, SoundInit.THE_ARMY_OF_MINOTAUR, new Item.Properties().tab(EMTabGroup.TABS).stacksTo(1).rarity(Rarity.RARE).fireResistant(), 3220));
    //刷怪蛋
