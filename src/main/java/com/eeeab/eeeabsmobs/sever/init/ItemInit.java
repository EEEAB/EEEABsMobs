...
public class ItemInit {
    ...
    public static final RegistryObject<Item> IMMORTAL_SKELETON_EGG =
            ITEMS.register("immortal_skeleton_egg",
                    () -> new ForgeSpawnEggItem(EntityInit.IMMORTAL_SKELETON, IMMORTAL_BACK_COLOR, rgb2dec(204, 0, 41),
                            new Item.Properties().tab(ModCreativeModeTabGroup.TABS).tab(ModCreativeModeTabGroup.TABS)));
    ...
    public static final RegistryObject<Item> IMMORTAL_KNIGHT_EGG =
            ITEMS.register("immortal_knight_egg",
                    () -> new ForgeSpawnEggItem(EntityInit.IMMORTAL_KNIGHT, IMMORTAL_BACK_COLOR, rgb2dec(0, 143, 204),
                            new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    ...
    public static final RegistryObject<Item> IMMORTAL_BONE = ITEMS.register("immortal_bone",
            () -> new ItemImmortalBone(new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    public static final RegistryObject<Item> IMMORTAL_HELMET = ITEMS.register("immortal_helmet",
            () -> new ItemArmorImmortal(EEArmorMaterial.IMMORTAL_MATERIAL, EquipmentSlot.HEAD, new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    public static final RegistryObject<Item> IMMORTAL_CHEST_PLATE = ITEMS.register("immortal_chest_plate",
            () -> new ItemArmorImmortal(EEArmorMaterial.IMMORTAL_MATERIAL, EquipmentSlot.CHEST, new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    public static final RegistryObject<Item> IMMORTAL_LEGGINGS = ITEMS.register("immortal_leggings",
            () -> new ItemArmorImmortal(EEArmorMaterial.IMMORTAL_MATERIAL, EquipmentSlot.LEGS, new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    public static final RegistryObject<Item> IMMORTAL_BOOTS = ITEMS.register("immortal_boots",
            () -> new ItemArmorImmortal(EEArmorMaterial.IMMORTAL_MATERIAL, EquipmentSlot.FEET, new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    public static final RegistryObject<Item> IMMORTAL_AXE = ITEMS.register("immortal_axe",
            () -> new ItemImmortalAxe(EEToolsTier.IMMORTAL_TIER, 6F, -2.8F, new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    public static final RegistryObject<Item> IMMORTAL_SWORD = ITEMS.register("immortal_sword",
            () -> new ImmortalSword(EEToolsTier.IMMORTAL_TIER, 5, -2.4F, new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    public static final RegistryObject<Item> IMMORTAL_STAFF = ITEMS.register("immortal_staff",
            () -> new ItemImmortalStaff(new Item.Properties().tab(ModCreativeModeTabGroup.TABS).stacksTo(1).rarity(Rarity.RARE).fireResistant()));
    public static final RegistryObject<Item> GUARDIAN_AXE = ITEMS.register("guardian_axe",
            () -> new ItemGuardianAxe(EEToolsTier.GUARDIAN_AXE_TIER, 10F, -3F, new Item.Properties().tab(ModCreativeModeTabGroup.TABS).rarity(Rarity.EPIC).fireResistant()));
    ...
    public static final RegistryObject<Item> IMMORTAL_INGOT = ITEMS.register("immortal_ingot", () -> new Item(new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    ...
    public static final RegistryObject<Item> GUARDIANS_MUSIC_DISC = ITEMS.register("guardians_music_disc",
            () -> new RecordItem(8, SoundInit.GUARDIANS, new Item.Properties().tab(ModCreativeModeTabGroup.TABS).stacksTo(1).rarity(Rarity.RARE), 3640));
    ...
    public static RegistryObject<Item> registerEgg(String name, RegistryObject<EntityType<? extends Mob>> EggObject, int backgroundColor, int highlightColor) {
        return ITEMS.register(name, () -> new ForgeSpawnEggItem(EggObject, backgroundColor, highlightColor, new Item.Properties().tab(ModCreativeModeTabGroup.TABS)));
    }
