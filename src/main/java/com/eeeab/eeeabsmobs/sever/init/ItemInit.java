...
public class ItemInit {
    ...
    public static final RegistryObject<Item> RELIC_OBSERVER_EGG = registerEgg("relic_observer_egg", EntityInit.RELIC_OBSERVER, rgb2dec(33, 33, 33), rgb2dec(126, 126, 126));
    public static final RegistryObject<Item> RELIC_RIPPER_EGG = registerEgg("relic_ripper_egg", EntityInit.RELIC_RIPPER, rgb2dec(95, 95, 95), rgb2dec(33, 33, 33));
    public static final RegistryObject<Item> RELIC_EARTHSHAKER_EGG = registerEgg("relic_earthshaker_egg", EntityInit.RELIC_EARTHSHAKER, rgb2dec(33, 33, 33), rgb2dec(67, 142, 180));
    public static final RegistryObject<Item> RELIC_ANNIHILATOR_EGG = registerEgg("relic_annihilator_egg", EntityInit.RELIC_ANNIHILATOR, rgb2dec(15, 15, 15), rgb2dec(100, 120, 150));
