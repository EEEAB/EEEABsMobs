...
import com.eeeab.eeeabsmobs.sever.world.level.feature.ErosionOakLeavesDecorator;
...
public class WorldGenInit {
    ...
    public static final RegistryObject<TreeDecoratorType<?>> EROSION_OAK_LEAVES = TREE_DECORATOR_TYPES.register("erosion_oak_leaves_decorator", () -> new TreeDecoratorType<>(ErosionOakLeavesDecorator.CODEC));
