...
public class ModCreativeModeTabGroup {
    ...
    public static final CreativeModeTab TABS = new CreativeModeTab(EEEABMobs.MOD_ID + ".creative_tab") {
        @Override
    ...
    //public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registry.CREATIVE_MODE_TAB, EEEABMobs.MOD_ID);
