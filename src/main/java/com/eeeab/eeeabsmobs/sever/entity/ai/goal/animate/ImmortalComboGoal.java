...
public class ImmortalComboGoal extends AnimationGroupAI<EntityImmortal> {
    ...
    private void doHurtTargetAndTryBreakBlock(float attackDistance, float attackHeight, float rightAttackArc, float leftAttackArc, float strength, boolean continuous, boolean disableShied, boolean canHit, boolean ignoreArmor, float hitEntityMaxHealth, float baseDamageMultiplier, float damageMultiplier) {
