...
public class AnimationRangeAIGoal<T extends EEEABMobLibrary & IAnimatedEntity> extends Goal {
    ...
    public AnimationRangeAIGoal(T mob, double speedModifier, int attackIntervalMin, float attackRadius, Item weapon, Predicate<T> customFlag, Animation animation) {
        this.attacker = mob;
