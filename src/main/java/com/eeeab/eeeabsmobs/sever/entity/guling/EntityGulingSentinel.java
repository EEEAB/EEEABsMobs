...
public class EntityGulingSentinel extends EntityAbsGuling implements IEntity, GlowEntity, CrackinessEntity<EntityGulingSentinel> {
    ...
    protected void registerCustomGoals() {
        ...
        this.goalSelector.addGoal(1, new AnimationAI<>(this) {
            ...
            public void tick() {
                ...
                this.entity.setDeltaMovement(0, this.entity.isOnGround() ? 0 : this.entity.getDeltaMovement().y, 0);
    ...
    public void tick() {
        ...
        if (!this.level.isClientSide) {
            ...
            if (this.getTarget() == null) this.yHeadRot = this.getYRot();
            ...
            if (!this.isNoAi() && this.isActive() && this.isNoAnimation() && this.getTarget() != null) {
                ...
                if (this.attackTick <= 0) {
                    ...
                    this.attackTick = 100 + this.random.nextInt(this.level.getDifficulty() == Difficulty.HARD ? 20 : 100);
                    this.getNavigation().stop();
                }
            }
        }
