...
public class EntityImmortalShuriken extends Projectile implements IEntity {
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        if (entity instanceof LivingEntity hitEntity) {
            ...
            entity.hurt(DamageSource.MAGIC, 11.4514F);
        }
    }
    ...
    public boolean canHitEntity(Entity entity) {
        if (!super.canHitEntity(entity) || (entity == getOwner()) || (entity instanceof EntityAbsImmortal && EMConfigHandler.COMMON.OTHER.enableSameMobsTypeInjury.get())) {
            return false;
        } else {
