package com.eeeab.eeeabsmobs.sever.entity.ai.pathfinder;
...
public class EMPathFinder extends net.minecraft.world.level.pathfinder.PathFinder {
    public EMPathFinder(NodeEvaluator processor, int maxVisitedNodes) {
