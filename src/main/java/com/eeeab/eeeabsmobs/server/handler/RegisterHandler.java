...
import com.eeeab.eeeabsmobs.server.init.BlockEntityInit;
import com.eeeab.eeeabsmobs.server.init.EntityInit;
import com.eeeab.eeeabsmobs.server.init.ParticleInit;
import com.eeeab.eeeabsmobs.server.integration.curios.model.ModelSoulSummoningNecklace;
...
public class RegisterHandler {
    ...
    public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayer.FALLEN_ENVOY, ModelFallenEnvoy::createBodyLayer);
    ...
    public static void registerRenderers(final EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityInit.FALLEN_ENVOY.get(), RenderFallenEnvoy::new);
    ...
    public static void onRegisterParticleProvidersEvent(final RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(ParticleInit.WARLOCK_HEAL.get(), FlameParticle.Provider::new);
