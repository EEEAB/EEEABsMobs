...
public class EntityImmortalSkeletonKnight extends EntityAbsImmortalSkeleton implements RangedAttackMob {
    ...
    private int timeUntilNextAlert;
    private int timeUntilBoost;

    public EntityImmortalSkeletonKnight(EntityType<? extends EntityImmortalSkeletonKnight> type, Level level) {
        super(type, level);
    }
    ...
    public void setTarget(@Nullable LivingEntity entity) {
        if (this.getTarget() == null && entity != null) {
            this.timeUntilNextAlert = ALERT_INTERVAL.sample(this.random);
        }
    ...
    private void maybeAlertOthers() {
        if (this.timeUntilNextAlert > 0) {
            --this.timeUntilNextAlert;
        } else {
