...
import com.eeeab.eeeabsmobs.server.entity.effect.EntityElectromagnetic;
...
public class EntityRelicAnnihilator extends AbstractRelicron implements IBoss, RangedAttackMob {
    ...
    public static final Animation SHOT_ANIMATION1 = AnimationNotification.create(35, null);
    ...
    public static final Animation TRICKSHOT_ANIMATION1 = AnimationNotification.create(20, null);
    ...
    public static final Animation LASER_ANIMATION = AnimationNotification.create(90, null);
