    ...
    public void tick() {
        ...
        if (tick == 1) entity.playSound(SoundInit.NAMELESS_GUARDIAN_CREAK.get(), 1.0F, 1.0F);
            ...
            entity.rangeAttack(4.6, 5, 4.6, 4.6, 40F, 40F, hitEntity -> {
                ...
                entity.guardianHurtTarget(ModDamageSource.guardianRobustAttack(entity), entity, hitEntity, 1.85F, 1.4F, true, true, true);
            });
        } else if (tick == 36) {
            ...
            for (int i = 2; i <= 12; i++) {
                entity.shockAttack(ModDamageSource.guardianRobustAttack(this.entity), i, 3F, 2F, 4F, 1.3F, 1.25F, true, false, true);
            }
        } else if (tick == 46) {
