package com.eeeab.eeeabsmobs.server.util;
...
public class ModMathUtils {
    ...
    public static ModMathUtils.Axis XN = new ModMathUtils.Axis(-1.0F, 0.0F, 0.0F);
    public static ModMathUtils.Axis XP = new ModMathUtils.Axis(1.0F, 0.0F, 0.0F);
    public static ModMathUtils.Axis YN = new ModMathUtils.Axis(0.0F, -1.0F, 0.0F);
    public static ModMathUtils.Axis YP = new ModMathUtils.Axis(0.0F, 1.0F, 0.0F);
    public static ModMathUtils.Axis ZN = new ModMathUtils.Axis(0.0F, 0.0F, -1.0F);
    public static ModMathUtils.Axis ZP = new ModMathUtils.Axis(0.0F, 0.0F, 1.0F);
    ...
    public static class Axis {
        ...
        public Quaternionf rotation(float angle) {
            return ModMathUtils.rotation(axis, angle, false);
        }

        public Quaternionf rotationDegrees(float degrees) {
            return ModMathUtils.rotation(axis, degrees, true);
        }
    }
}
