...
public class TranslateUtils {
    ...
    public static Component simpleText(String prefix, String key, ChatFormatting format, @Nullable Object... args) {
        return simpleText(null, prefix, key, format, TIP_SUFFIX, args);
    }

    public static Component simpleText(String namespace, String prefix, @NotNull String key, ChatFormatting format, String suffix, @Nullable Object... args) {
        if (args == null) args = new Object[0];
        MutableComponent component;
        namespace = namespace == null ? MOD_ID : namespace + ".";
    ...
    public static Component simpleConfigText(String key, ChatFormatting format, @Nullable Object... args) {
        return simpleText(null, CONFIG_PREFIX, key, format, "", args);
    }
    ...
    public static String subDescriptionId(@NotNull String descriptionId) {
