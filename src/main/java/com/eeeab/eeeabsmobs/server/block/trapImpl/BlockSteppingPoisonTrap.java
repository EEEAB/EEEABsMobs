...
import com.eeeab.eeeabsmobs.server.block.BlockStepOnTrap;
...
public class BlockSteppingPoisonTrap extends BlockStepOnTrap {
    public BlockSteppingPoisonTrap(Properties pProperties) {
        super(pProperties);
    }
