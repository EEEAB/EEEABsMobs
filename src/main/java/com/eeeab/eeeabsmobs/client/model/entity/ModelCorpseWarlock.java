...
public class ModelCorpseWarlock extends EMHierarchicalModel<EntityCorpseWarlock> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(34, 0).addBox(-3.7F, -4.7F, -4.3F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.0872F, 0.7844F, 0.0617F));
