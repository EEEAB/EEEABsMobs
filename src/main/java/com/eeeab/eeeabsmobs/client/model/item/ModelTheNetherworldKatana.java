...
public class ModelTheNetherworldKatana extends EntityModel<Entity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition blade = root.addOrReplaceChild("blade", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -55.4F, -2.5F, 9.0F, 54.0F, 5.0F, new CubeDeformation(-2.0F))
                .texOffs(0, 0).addBox(-4.625F, -58.2F, -2.5F, 9.0F, 7.0F, 5.0F, new CubeDeformation(-2.15F))
                .texOffs(0, 0).addBox(-4.725F, -60.8F, -2.5F, 9.0F, 7.0F, 5.0F, new CubeDeformation(-2.25F))
                .texOffs(0, 0).addBox(-4.925F, -63.1F, -2.5F, 9.0F, 7.0F, 5.0F, new CubeDeformation(-2.45F))
