...
public class ModelGuardianBlade extends AdvancedEntityModel<EntityGuardianBlade> {
    ...
    public ModelGuardianBlade() {
        ...
        root.setPos(0.0F, 24.0F, -13.0F);
        root.mirror=true;
        root.setTextureOffset(0,0).addBox(-2.0F, -13.0F, 2.0F, 4.0F, 13.0F, 35.0F)
                .setTextureOffset(0,180).addBox(0.0F, -13.0F, 37.0F, 0.0F, 13.0F, 35.0F);

        upper=new AdvancedModelBox(this,"upper");
        upper.setPos(0.0F, 0.0F, 13.0F);
        root.addChild(upper);
        upper.setTextureOffset(89, 0).addBox(-1.0F, -34.0F, -11.0F, 2.0F, 21.0F, 24.0F)
                ...
                .setTextureOffset(0, 0).addBox(0-0.5F, -55.0F, -11.0F, 1.0F, 21.0F, 8.0F);

        lower=new AdvancedModelBox(this,"lower");
        lower.setPos(0.0F, -14.0F, 13.0F);
        root.addChild(lower);
        lower.mirror=true;
