...
public class ModelRelicAnnihilator extends ModHierarchicalModel<EntityRelicAnnihilator> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("up", CubeListBuilder.create().texOffs(72, 32).addBox(-4.5F, -3.0F, -4.0F, 9.0F, 6.0F, 8.0F, new CubeDeformation(-0.45F)), PartPose.offset(0.0F, -3.35F, -3.0F));
        head.addOrReplaceChild("down", CubeListBuilder.create().texOffs(76, 0).addBox(-4.5F, -3.0F, -4.0F, 9.0F, 6.0F, 8.0F, new CubeDeformation(-0.45F)), PartPose.offset(0.0F, 1.75F, -3.0F));
        head.addOrReplaceChild("scope", CubeListBuilder.create().texOffs(62, 71).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-1.5F)), PartPose.offset(0.0F, -1.25F, -1.0F));
        head.addOrReplaceChild("infrared", CubeListBuilder.create().texOffs(108, 8).addBox(-0.5F, -1.1F, -1.5F, 3.0F, 3.0F, 7.0F, new CubeDeformation(-0.5F)), PartPose.offset(-1.0F, 1.75F, -1.7F));
        PartDefinition leftArm = upper.addOrReplaceChild("leftArm", CubeListBuilder.create(), PartPose.offset(16.5F, -21.0F, 0.0F));
        leftArm.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(44, 18).addBox(-2.5F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 18.5F, 0.0F, 0.0873F, 0.0611F, 1.5708F));
        leftArm.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(21, 96).addBox(-4.5F, -4.5F, -5.0F, 9.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.2071F, -1.7929F, 0.0F, 0.0873F, 0.0F, -0.0436F));
        leftArm.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 49).addBox(-3.5F, -7.0F, -3.5F, 7.0F, 15.0F, 7.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(1.5F, 9.0F, 0.0F, 0.0F, -0.7854F, 0.0F));
        ...
        leftBooster.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(24, 80).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, 1.5708F, 0.0F, -0.7854F));
        ...
        leftExhaust.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(4, 108).addBox(-1.5F, -2.5F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 1.45F, 1.5708F, 0.0F, -0.7854F));
        leftExhaust.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 106).addBox(-2.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 1.6F, 1.5708F, 0.0F, -0.7854F));
        ...
        leftHand.addOrReplaceChild("muzzle", CubeListBuilder.create(), PartPose.offset(0.0F, 12.0F, 0.0F));
        leftHand.addOrReplaceChild("cover", CubeListBuilder.create().texOffs(54, 18).addBox(-5.7365F, 3.0284F, -5.5F, 9.0F, 3.0F, 11.0F, new CubeDeformation(0.15F)).texOffs(46, 79).addBox(3.2635F, -2.9716F, -4.0F, 3.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 17.0F, 0.0F));
        PartDefinition rightArm = upper.addOrReplaceChild("rightArm", CubeListBuilder.create(), PartPose.offset(-16.5F, -21.0F, 0.0F));
        rightArm.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(21, 96).mirror().addBox(-4.5F, -4.5F, -5.0F, 9.0F, 9.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.2071F, -1.7929F, 0.0F, 0.0873F, 0.0F, 0.0436F));
        rightArm.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(44, 18).mirror().addBox(-2.5F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, 18.5F, 0.0F, -0.0873F, 0.0611F, 1.5708F));
        rightArm.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 49).mirror().addBox(-3.5F, -7.0F, -3.5F, 7.0F, 15.0F, 7.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(-1.5F, 9.0F, 0.0F, 0.0F, 0.7854F, 0.0F));
        ...
        rightBooster.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(24, 80).mirror().addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, 1.5708F, 0.0F, 0.7854F));
        ...
        rightExhaust.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(2, 108).mirror().addBox(-1.5F, -2.5F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 1.45F, 1.5708F, 0.0F, 0.7854F));
        rightExhaust.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 106).mirror().addBox(-2.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 1.6F, 1.5708F, 0.0F, 0.7854F));
        ...
        saw.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(70, 89).mirror().addBox(-3.9393F, -2.6F, -5.3536F, 10.0F, 3.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 1.0F, -0.5F, 0.0F, -0.7854F, 0.0F));
        ...
        blade1.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(54, 32).mirror().addBox(0.3011F, -1.8847F, -2.2353F, 6.0F, 3.0F, 5.0F, new CubeDeformation(-0.7F)).mirror(false), PartPose.offsetAndRotation(-1.2701F, 0.6468F, 4.7571F, -0.0632F, -0.2196F, -0.048F));
        blade1.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(81, 58).mirror().addBox(-2.8627F, -2.419F, -4.3756F, 8.0F, 3.0F, 9.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(-1.4521F, 1.1468F, 0.9538F, 0.0F, -0.7854F, 0.0F));
        ...
        blade2.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(98, 26).mirror().addBox(-4.1723F, -2.2928F, -2.2157F, 6.0F, 3.0F, 5.0F, new CubeDeformation(-0.7F)).mirror(false), PartPose.offsetAndRotation(1.2701F, 0.734F, -5.7532F, 0.0632F, -0.2196F, 0.048F));
        blade2.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(83, 14).mirror().addBox(-3.0468F, -2.7662F, -5.3382F, 8.0F, 3.0F, 9.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(1.4521F, 1.234F, -1.9499F, 0.0F, -0.7854F, 0.0F));
        ...
        blade3.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(103, 0).mirror().addBox(-5.5027F, -2.0185F, -1.4065F, 6.0F, 3.0F, 5.0F, new CubeDeformation(-0.7F)).mirror(false), PartPose.offsetAndRotation(-4.7831F, 0.5168F, -2.2469F, 0.2802F, 1.346F, 0.2117F));
        blade3.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(81, 46).mirror().addBox(-3.7341F, -2.6147F, -3.9223F, 8.0F, 3.0F, 9.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(-0.9651F, 1.0168F, -2.4436F, 0.0F, 0.7854F, 0.0F));
        ...
        blade4.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(106, 58).mirror().addBox(-1.0293F, -2.159F, -1.4262F, 6.0F, 3.0F, 5.0F, new CubeDeformation(-0.7F)).mirror(false), PartPose.offsetAndRotation(4.7604F, 0.7769F, 0.264F, -0.2802F, 1.346F, -0.2117F));
        blade4.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(94, 77).mirror().addBox(-3.5501F, -2.5705F, -2.9598F, 8.0F, 3.0F, 9.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(0.9424F, 1.2769F, 0.4607F, 0.0F, 0.7854F, 0.0F));
        ...
        leftLeg.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(44, 18).addBox(-2.5F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(1.0F, 13.2523F, -4.9121F, 0.0F, -0.3491F, 1.5708F));
        leftLeg.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(0, 71).addBox(-2.5F, -7.5F, -2.5F, 6.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 3.4523F, -2.1121F, -0.2618F, 0.0F, 0.0F));
        ...
        leftLegUnder.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(106, 34).addBox(-2.5F, -5.5F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 1.0F, 0.2618F, 0.0F, 0.0F));
        ...
        leftWheelJoint.addOrReplaceChild("leftWheel", CubeListBuilder.create().texOffs(24, 62).addBox(-4.5F, -4.5F, -4.5F, 5.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.5F, 0.0F));
        PartDefinition rightLeg = lower.addOrReplaceChild("rightLeg", CubeListBuilder.create(), PartPose.offset(-6.5F, 1.5477F, 0.6121F));
        rightLeg.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(44, 18).mirror().addBox(-2.5F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 13.2523F, -4.9121F, 0.0F, 0.3491F, -1.5708F));
        rightLeg.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(0, 71).addBox(-3.5F, -7.5F, -2.5F, 6.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 3.4523F, -2.1121F, -0.2618F, 0.0F, 0.0F));
        ...
        rightLegUnder.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(106, 34).addBox(-2.5F, -5.5F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 1.0F, 0.2618F, 0.0F, 0.0F));
        ...
        rightWheelJoint.addOrReplaceChild("rightWheel", CubeListBuilder.create().texOffs(24, 62).mirror().addBox(-0.5F, -4.5F, -4.5F, 5.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 8.5F, 0.0F));
