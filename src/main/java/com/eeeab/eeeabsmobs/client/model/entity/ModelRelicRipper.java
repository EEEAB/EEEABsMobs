...
public class ModelRelicRipper extends ModHierarchicalModel<EntityRelicRipper> {
    ...
    private final ModelPart rightLegJoint1;
    private final ModelPart rightLegJoint2;
    private final ModelPart rightFoot;
    private final ModelPart leftFoot;
    private final ModelPart leftLegJoint1;
    private final ModelPart leftLegJoint2;
    ...
    public ModelRelicRipper(ModelPart root) {
        ...
        this.rightLegJoint1 = this.rightLeg.getChild("rightLegJoint1");
        this.rightLegJoint2 = this.rightLegJoint1.getChild("rightLegJoint2");
        this.rightFoot = this.rightLegJoint2.getChild("rightFoot");
        this.leftLeg = this.lower.getChild("leftLeg");
        this.leftLegJoint1 = this.leftLeg.getChild("leftLegJoint1");
        this.leftLegJoint2 = this.leftLegJoint1.getChild("leftLegJoint2");
        this.leftFoot = this.leftLegJoint2.getChild("leftFoot");
    }
    ...
    public void setupAnim(EntityRelicRipper entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.isNoAnimation()) {
            if (!entity.isActive()) {
                ...
                setStaticRotationAngle(rightHand, -12F, 0F, 0F);
                setStaticRotationAngle(upper, 25F, 0F, 0F);
                setStaticRotationAngle(lower, 10F, 0F, 0F);
                setStaticRotationAngle(rightLeg, -15F, 0F, 0F);
                setStaticRotationAngle(rightLegJoint2, -22.5F, 0F, 0F);
                setStaticRotationAngle(rightLegJoint1, 22.5F, 0F, 0F);
                setStaticRotationAngle(rightFoot, 5, 0F, 0F);
                setStaticRotationAngle(leftLeg, -15F, 0F, 0F);
                setStaticRotationAngle(leftLegJoint2, -22.5F, 0F, 0F);
                setStaticRotationAngle(leftLegJoint1, 22.5F, 0F, 0F);
