...
public class ModelImmortal extends EMHierarchicalModel<EntityImmortal> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r16 = body.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(111, 31).mirror().addBox(-7.0F, -4.5F, -2.5F, 12.0F, 12.0F, 3.0F, new CubeDeformation(1.0F)).mirror(false)
        ...
        PartDefinition cube_r25 = leftPauldrons.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(60, 166).addBox(0.6691F, 2.2101F, -0.2976F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9985F, 2.9863F, 4.4988F, 1.1771F, 0.9776F, -1.1045F));
        PartDefinition cube_r26 = leftPauldrons.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(149, 173).addBox(-10.6182F, -10.8169F, 4.6838F, 17.0F, 23.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r43 = rightPauldrons.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(60, 166).mirror().addBox(-5.6691F, 2.2101F, -0.2976F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.9985F, 2.9863F, 4.4988F, 1.1771F, -0.9776F, 1.1045F));
        PartDefinition cube_r44 = rightPauldrons.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(149, 173).mirror().addBox(-6.3818F, -10.8169F, 4.6838F, 17.0F, 23.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
