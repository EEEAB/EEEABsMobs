...
public class ModelNamelessGuardian extends EMHierarchicalModel<EntityNamelessGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = upper.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -22.9649F, -10.06F, 0.1745F, 0.0F, 0.0F));
        PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(141, 1).addBox(-6.3297F, -12.551F, -5.6703F, 12.0F, 16.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(149, 31).addBox(-4.0297F, -10.0551F, -3.9703F, 8.0F, 11.0F, 8.0F, new CubeDeformation(1.5F)), PartPose.offsetAndRotation(0.2563F, -3.9949F, -0.6028F, 0.0F, 0.7854F, 0.0F));
        ...
        PartDefinition cube_r2 = tooth.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(109, 27).mirror().addBox(-0.9127F, -4.8649F, 4.0723F, 2.5F, 8.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offsetAndRotation(-7.9651F, 3.692F, -4.944F, 0.6109F, 0.2618F, -0.1745F));
        PartDefinition cube_r3 = tooth.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(109, 27).addBox(-1.5127F, -4.8649F, 4.0723F, 2.5F, 8.0F, 3.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(7.7325F, 3.692F, -4.944F, 0.6109F, -0.2618F, 0.1745F));
        PartDefinition body = upper.addOrReplaceChild("body", CubeListBuilder.create().texOffs(7, 37).addBox(-10.8532F, -13.2245F, -7.5671F, 22.0F, 14.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(81, 1).addBox(-8.8958F, 0.6606F, -6.0245F, 18.5F, 3.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.8514F, 0.0F, 0.0436F, 0.0F, 0.0F));
        PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 1).addBox(-14.0F, -7.5F, -8.5F, 28.0F, 15.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2319F, -19.0651F, -2.4809F, 0.1745F, 0.0F, 0.0F));
        PartDefinition heart = body.addOrReplaceChild("heart", CubeListBuilder.create(), PartPose.offset(-0.1F, -4.9952F, 0.2181F));
        PartDefinition cube_r5 = heart.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(6, 68).addBox(-5.1169F, -5.2872F, -5.9841F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3488F, -12.8827F, -2.7149F, 0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r6 = rightArmAbove.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(220, 29).addBox(-6.4019F, 5.9513F, -3.0089F, 9.0F, 12.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3488F, -0.5688F, 0.0159F, 0.3054F, 0.0F, 0.1745F));
        ...
        PartDefinition cube_r7 = rightArmUnder.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(208, 53).addBox(-6.7039F, -6.359F, -2.9365F, 12.0F, 15.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4252F, 5.1048F, -3.205F, 0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition lever = axe.addOrReplaceChild("lever", CubeListBuilder.create().texOffs(0, 156).addBox(3.0801F, 4.9444F, -16.8786F, 3.0F, 3.0F, 36.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(3, 209).addBox(3.1801F, 4.6444F, 25.1214F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(88, 201).addBox(3.1801F, 2.2444F, -42.2786F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(42, 204).addBox(4.0801F, 1.0944F, -48.7786F, 1.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, -4.4F, 0.0F));
        PartDefinition cube_r8 = lever.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(84, 186).addBox(-2.3102F, 5.7362F, -8.4468F, 4.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.7303F, 0.6472F, -11.2938F, -0.4363F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r9 = blade.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(102, 192).addBox(-2.3F, -8.5F, -4.5F, 5.0F, 16.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.7301F, -8.9005F, -34.8688F, 1.9199F, 0.0F, 0.0F));
        PartDefinition cube_r10 = blade.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(132, 197).addBox(-1.8949F, -14.3568F, -2.9102F, 4.0F, 13.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.6F, -13.2029F, -31.8596F, -2.2078F, 0.0F, 0.0F));
        PartDefinition cube_r11 = blade.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(182, 186).addBox(-1.8699F, -5.8044F, -3.1078F, 4.0F, 16.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.6F, 16.0029F, -31.8596F, -1.9199F, 0.0F, 0.0F));
        PartDefinition cube_r12 = blade.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(156, 191).addBox(-1.8949F, -6.3321F, -9.8793F, 4.0F, 18.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.6F, 16.0029F, -31.8596F, 2.2078F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r13 = leftArmAbove.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(220, 29).mirror().addBox(-1.698F, 5.9513F, -3.0089F, 9.0F, 12.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.3488F, -0.5688F, 0.0159F, 0.3054F, 0.0F, -0.1745F));
        ...
        PartDefinition cube_r14 = leftArmUnder.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(208, 53).mirror().addBox(-5.5641F, -6.559F, -2.3677F, 12.0F, 15.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.3772F, 5.6109F, -2.3331F, 0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition rightLegAbove = rightLeg.addOrReplaceChild("rightLegAbove", CubeListBuilder.create().texOffs(146, 54).addBox(-4.0235F, -1.7708F, -6.1544F, 9.0F, 12.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r15 = rightLegUnder.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(74, 38).addBox(-5.5426F, -3.0851F, -9.2554F, 11.0851F, 3.0851F, 3.0851F, new CubeDeformation(0.0F))
        ...
        PartDefinition leftLegAbove = leftLeg.addOrReplaceChild("leftLegAbove", CubeListBuilder.create().texOffs(146, 54).mirror().addBox(-4.0235F, -1.7708F, -6.1544F, 9.0F, 12.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r16 = leftLegUnder.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(74, 38).mirror().addBox(-5.5426F, -3.0851F, -9.2554F, 11.0851F, 3.0851F, 3.0851F, new CubeDeformation(0.0F)).mirror(false)
