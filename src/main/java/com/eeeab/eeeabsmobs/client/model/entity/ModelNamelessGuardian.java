...
public class ModelNamelessGuardian extends EMHierarchicalModel<EntityNamelessGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r3 = tooth.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(109, 27).mirror().addBox(-0.9127F, -4.8649F, 4.0723F, 2.5F, 8.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-7.9651F, 3.692F, -4.944F, 0.6109F, 0.2618F, -0.1745F));
        PartDefinition cube_r4 = tooth.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(109, 27).addBox(-1.5127F, -4.8649F, 4.0723F, 2.5F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.7325F, 3.692F, -4.944F, 0.6109F, -0.2618F, 0.1745F));
        ...
        PartDefinition cube_r11 = blade.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(132, 197).addBox(-1.8949F, -14.3568F, -2.9102F, 4.0F, 13.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.6F, -13.2029F, -31.8596F, -2.2078F, 0.0F, 0.0F));
        PartDefinition cube_r12 = blade.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(182, 186).addBox(-1.8699F, -5.8044F, -3.1078F, 4.0F, 16.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.6F, 16.0029F, -31.8596F, -1.9199F, 0.0F, 0.0F));
        PartDefinition cube_r13 = blade.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(156, 191).addBox(-1.8949F, -6.3321F, -9.8793F, 4.0F, 18.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.6F, 16.0029F, -31.8596F, 2.2078F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r16 = rightLegUnder.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(74, 38).addBox(-5.5426F, -3.0851F, -9.2554F, 11.0851F, 3.0851F, 3.0851F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r17 = leftLegUnder.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(74, 38).mirror().addBox(-5.5426F, -3.0851F, -9.2554F, 11.0851F, 3.0851F, 3.0851F, new CubeDeformation(0.0F)).mirror(false)
