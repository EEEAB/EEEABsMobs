...
public class ModelTheImmortal extends AdvancedEntityModel<EntityTheImmortal> implements ArmedModel {
    ...
    private void animate(EntityTheImmortal entityTest, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public void setupAnim(EntityTheImmortal entityTest, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
