...
public class  ModelTheImmortal extends EMHierarchicalModel<EntityTheImmortal> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r31 = cusp2.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(136, 48).mirror().addBox(-2.0F, -15.5F, -2.5F, 4.0F, 17.0F, 5.0F, new CubeDeformation(-1.5001F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.384F));
        PartDefinition cube_r32 = cusp2.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(179, 50).mirror().addBox(-2.0F, -4.5F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-1.501F)).mirror(false), PartPose.offsetAndRotation(1.1F, 0.2F, 0.0F, 0.0F, 0.0F, 0.0175F));
        PartDefinition cube_r33 = cusp2.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(179, 50).mirror().addBox(-2.0F, -6.5F, -2.5F, 4.0F, 8.0F, 5.0F, new CubeDeformation(-1.501F)).mirror(false), PartPose.offsetAndRotation(2.1F, -0.1F, 0.0F, 0.0F, 0.0F, 0.0175F));
        PartDefinition cube_r34 = cusp2.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(179, 50).mirror().addBox(-2.0F, -9.5F, -2.5F, 4.0F, 11.0F, 5.0F, new CubeDeformation(-1.501F)).mirror(false), PartPose.offsetAndRotation(3.0F, 0.2F, 0.0F, 0.0F, 0.0F, 0.0175F));
        PartDefinition cube_r35 = cusp2.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(157, 48).mirror().addBox(-2.0F, -14.5F, -2.5F, 4.0F, 16.0F, 5.0F, new CubeDeformation(-1.49F)).mirror(false), PartPose.offsetAndRotation(5.0F, -0.3F, 0.0F, 0.0F, 0.0F, 0.0175F));
        PartDefinition cube_r36 = cusp2.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(179, 50).mirror().addBox(-2.0F, -11.5F, -2.5F, 4.0F, 13.0F, 5.0F, new CubeDeformation(-1.501F)).mirror(false), PartPose.offsetAndRotation(4.0F, -0.3F, 0.0F, 0.0F, 0.0F, 0.0175F));
        ...
        PartDefinition cube_r37 = hilt2.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(185, 205).mirror().addBox(-5.0F, -2.5F, -4.5F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.75F, -0.5F, -0.5F, 0.0F, -0.7854F, 0.0F));
        PartDefinition cube_r38 = hilt2.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(218, 226).mirror().addBox(-2.5F, -10.5F, -2.5F, 5.0F, 21.0F, 5.0F, new CubeDeformation(-0.5F)).mirror(false), PartPose.offsetAndRotation(0.25F, 9.5F, 0.0F, 0.0F, -0.7854F, 0.0F));
        PartDefinition rightArm = body.addOrReplaceChild("rightArm", CubeListBuilder.create(), PartPose.offset(-25.2984F, -19.037F, 15.8276F));
        PartDefinition cube_r39 = rightArm.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(1.7401F, -8.8132F, 0.472F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r40 = rightArm.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(38, 192).mirror().addBox(-2.6883F, -11.9726F, -10.7928F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-13.7921F, -15.5094F, -3.2545F, 0.1018F, -0.9985F, -1.0466F));
        PartDefinition cube_r41 = rightArm.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(38, 192).mirror().addBox(3.5478F, -10.9907F, -10.6662F, 0.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-10.5801F, -17.7127F, 2.286F, -0.9286F, -0.4523F, 0.3292F));
        PartDefinition cube_r42 = rightArm.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(60, 166).mirror().addBox(-5.6691F, 2.2101F, -0.2976F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-18.5786F, 2.2736F, 8.2848F, 1.1771F, -0.9776F, 1.1045F));
        PartDefinition cube_r43 = rightArm.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(149, 173).mirror().addBox(-6.3818F, -10.8169F, 4.6838F, 17.0F, 23.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r44 = rightArm.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(90, 107).mirror().addBox(-8.0F, -14.0F, -19.7F, 5.0F, 23.0F, 23.0F, new CubeDeformation(0.0F)).mirror(false)
        ...
        PartDefinition cube_r45 = rightArmUnder.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(76, 162).mirror().addBox(-6.6874F, -7.3598F, -3.4177F, 9.0F, 13.0F, 26.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.5481F, 24.4179F, -1.9504F, 1.354F, -0.0271F, -0.1101F));
        PartDefinition cube_r46 = rightArmUnder.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(1, 114).mirror().addBox(-6.5775F, -5.5F, -25.1487F, 11.0F, 11.0F, 25.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.7211F, -0.9818F, 2.0572F, 1.4029F, 0.0479F, 0.2752F));
        ...
        PartDefinition cube_r47 = rightFist.addOrReplaceChild("cube_r47", CubeListBuilder.create().texOffs(50, 117).mirror().addBox(-49.1809F, -5.1008F, -3.5475F, 10.0F, 10.0F, 9.0F, new CubeDeformation(0.5F)).mirror(false), PartPose.offsetAndRotation(44.1908F, 3.8069F, 0.0518F, 1.3091F, -0.0045F, -0.0258F));
        ...
        PartDefinition cube_r48 = cusp1.addOrReplaceChild("cube_r48", CubeListBuilder.create().texOffs(117, 201).addBox(-2.0F, -15.5F, -2.5F, 4.0F, 17.0F, 5.0F, new CubeDeformation(-1.5001F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.384F));
        PartDefinition cube_r49 = cusp1.addOrReplaceChild("cube_r49", CubeListBuilder.create().texOffs(77, 205).addBox(-2.0F, -4.5F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-1.501F)), PartPose.offsetAndRotation(-1.1F, 0.2F, 0.0F, 0.0F, 0.0F, -0.0175F));
        PartDefinition cube_r50 = cusp1.addOrReplaceChild("cube_r50", CubeListBuilder.create().texOffs(77, 205).addBox(-2.0F, -6.5F, -2.5F, 4.0F, 8.0F, 5.0F, new CubeDeformation(-1.501F)), PartPose.offsetAndRotation(-2.1F, -0.1F, 0.0F, 0.0F, 0.0F, -0.0175F));
        PartDefinition cube_r51 = cusp1.addOrReplaceChild("cube_r51", CubeListBuilder.create().texOffs(77, 205).addBox(-2.0F, -9.5F, -2.5F, 4.0F, 11.0F, 5.0F, new CubeDeformation(-1.501F)), PartPose.offsetAndRotation(-3.0F, 0.2F, 0.0F, 0.0F, 0.0F, -0.0175F));
        PartDefinition cube_r52 = cusp1.addOrReplaceChild("cube_r52", CubeListBuilder.create().texOffs(97, 202).addBox(-2.0F, -14.5F, -2.5F, 4.0F, 16.0F, 5.0F, new CubeDeformation(-1.49F)), PartPose.offsetAndRotation(-5.0F, -0.3F, 0.0F, 0.0F, 0.0F, -0.0175F));
        PartDefinition cube_r53 = cusp1.addOrReplaceChild("cube_r53", CubeListBuilder.create().texOffs(77, 205).addBox(-2.0F, -11.5F, -2.5F, 4.0F, 13.0F, 5.0F, new CubeDeformation(-1.501F)), PartPose.offsetAndRotation(-4.0F, -0.3F, 0.0F, 0.0F, 0.0F, -0.0175F));
        PartDefinition hilt = r_netherworld_katana.addOrReplaceChild("hilt", CubeListBuilder.create(), PartPose.offset(0.25F, -10.0F, 0.0F));
        PartDefinition cube_r54 = hilt.addOrReplaceChild("cube_r54", CubeListBuilder.create().texOffs(141, 205).addBox(-5.0F, -2.5F, -4.5F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, -0.5F, -0.5F, 0.0F, 0.7854F, 0.0F));
        PartDefinition cube_r55 = hilt.addOrReplaceChild("cube_r55", CubeListBuilder.create().texOffs(196, 226).addBox(-2.5F, -10.5F, -2.5F, 5.0F, 21.0F, 5.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.25F, 9.5F, 0.0F, 0.0F, 0.7854F, 0.0F));
        ...
        PartDefinition cube_r56 = miniLeftArm.addOrReplaceChild("cube_r56", CubeListBuilder.create().texOffs(0, 155).addBox(3.2626F, -16.2447F, -1.6113F, 5.0F, 21.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5261F, 14.0016F, -8.494F, -0.5368F, 0.1339F, -0.6748F));
        ...
        PartDefinition cube_r57 = miniLeftArmUnder.addOrReplaceChild("cube_r57", CubeListBuilder.create().texOffs(0, 155).addBox(-2.0126F, -1.8234F, -1.3558F, 5.0F, 21.0F, 5.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-0.4866F, 1.0169F, 1.0386F, -2.7484F, -0.3018F, -1.5377F));
        ...
        PartDefinition cube_r58 = claw1.addOrReplaceChild("cube_r58", CubeListBuilder.create().texOffs(22, 173).addBox(-3.5F, -5.0F, 0.6F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.1012F, -1.3441F, -1.8301F, -2.7527F, 0.2655F, -1.308F));
        ...
        PartDefinition cube_r59 = claw2.addOrReplaceChild("cube_r59", CubeListBuilder.create().texOffs(22, 173).addBox(-4.1F, -5.0F, 1.6F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.7667F, -2.1193F, -0.4729F, -2.7527F, 0.2655F, -1.308F));
        ...
        PartDefinition cube_r60 = claw3.addOrReplaceChild("cube_r60", CubeListBuilder.create().texOffs(22, 173).addBox(-6.1145F, -3.6076F, -0.202F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0822F, -0.5564F, -0.9716F, -2.7527F, 0.2655F, -1.308F));
        ...
        PartDefinition cube_r61 = miniRightArm.addOrReplaceChild("cube_r61", CubeListBuilder.create().texOffs(0, 155).mirror().addBox(-8.2626F, -16.2447F, -1.6113F, 5.0F, 21.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5261F, 14.0016F, -8.494F, -0.5368F, -0.1339F, 0.6748F));
        ...
        PartDefinition cube_r62 = miniRightArmUnder.addOrReplaceChild("cube_r62", CubeListBuilder.create().texOffs(0, 155).mirror().addBox(-2.9874F, -1.8234F, -1.3558F, 5.0F, 21.0F, 5.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(0.4866F, 1.0169F, 1.0386F, -2.7484F, 0.3018F, 1.5377F));
        ...
        PartDefinition cube_r63 = claw4.addOrReplaceChild("cube_r63", CubeListBuilder.create().texOffs(22, 173).mirror().addBox(-3.5F, -5.0F, 0.6F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.1012F, -1.3441F, -1.8301F, -2.7527F, -0.2655F, 1.308F));
        ...
        PartDefinition cube_r64 = claw5.addOrReplaceChild("cube_r64", CubeListBuilder.create().texOffs(22, 173).mirror().addBox(-2.9F, -5.0F, 1.6F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.7667F, -2.1193F, -0.4729F, -2.7527F, -0.2655F, 1.308F));
        ...
        PartDefinition cube_r65 = claw6.addOrReplaceChild("cube_r65", CubeListBuilder.create().texOffs(22, 173).mirror().addBox(-0.8855F, -3.6076F, -0.202F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.0822F, -0.5564F, -0.9716F, -2.7527F, -0.2655F, 1.308F));
        ...
        PartDefinition cube_r66 = core.addOrReplaceChild("cube_r66", CubeListBuilder.create().texOffs(143, 28).addBox(-4.5F, -4.5F, -4.5F, 9.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3171F, 0.8035F, 0.232F));
        ...
        PartDefinition cube_r67 = lower.addOrReplaceChild("cube_r67", CubeListBuilder.create().texOffs(0, 216).addBox(-0.9853F, -0.1706F, -10.6247F, 3.0F, 15.0F, 21.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(13.5777F, 12.6478F, 12.9483F, 0.3656F, -0.7279F, -0.5069F));
        PartDefinition cube_r68 = lower.addOrReplaceChild("cube_r68", CubeListBuilder.create().texOffs(50, 216).addBox(2.6412F, -1.6601F, -7.1467F, 3.0F, 18.0F, 18.0F, new CubeDeformation(0.5F)), PartPose.offsetAndRotation(8.7433F, 2.3785F, 4.9792F, 0.4973F, -0.6546F, -0.7127F));
        PartDefinition cube_r69 = lower.addOrReplaceChild("cube_r69", CubeListBuilder.create().texOffs(0, 216).mirror().addBox(-2.0147F, -0.1706F, -10.6247F, 3.0F, 15.0F, 21.0F, new CubeDeformation(0.5F)).mirror(false), PartPose.offsetAndRotation(-13.5777F, 12.6478F, 12.9483F, 0.3656F, 0.7279F, 0.5069F));
        PartDefinition cube_r70 = lower.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(50, 216).mirror().addBox(-5.6412F, -1.6601F, -7.1467F, 3.0F, 18.0F, 18.0F, new CubeDeformation(0.5F)).mirror(false), PartPose.offsetAndRotation(-8.7433F, 2.3785F, 4.9792F, 0.4973F, 0.6546F, 0.7127F));
        PartDefinition cube_r71 = lower.addOrReplaceChild("cube_r71", CubeListBuilder.create().texOffs(0, 184).addBox(-9.0F, -6.5398F, -3.0F, 15.0F, 27.0F, 3.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(1.5F, 2.1635F, -11.6503F, -0.4363F, 0.0F, 0.0F));
        PartDefinition cube_r72 = lower.addOrReplaceChild("cube_r72", CubeListBuilder.create().texOffs(38, 165).addBox(-1.5F, -5.0F, -1.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.5418F, -19.4711F, -0.583F, -0.6956F, 0.3999F));
        PartDefinition cube_r73 = lower.addOrReplaceChild("cube_r73", CubeListBuilder.create().texOffs(38, 186).mirror().addBox(-16.3677F, -1.2821F, -0.8157F, 15.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -2.6178F, -15.7229F, -0.4998F, 0.1958F, 0.0779F));
        PartDefinition cube_r74 = lower.addOrReplaceChild("cube_r74", CubeListBuilder.create().texOffs(38, 186).addBox(1.3677F, -1.2821F, -0.8157F, 15.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.6178F, -15.7229F, -0.4998F, -0.1958F, -0.0779F));
