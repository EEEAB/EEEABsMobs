...
public class LayerGuardianCore extends LayerGlow<EntityNamelessGuardian, ModelNamelessGuardian> {
    private static final ResourceLocation GLOW_LAYER = new ResourceLocation(EEEABMobs.MOD_ID, "textures/entity/guling_sentinel/nameless_guardian/nameless_guardian_core.png");
