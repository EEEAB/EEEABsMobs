...
import com.eeeab.eeeabsmobs.server.entity.effect.EntityImmortalMagicCircle;
...
public class RenderImmortalMagicCircle extends FlatTextureRenderer<EntityImmortalMagicCircle> {
    ...
    private static final ResourceLocation POWER_TEXTURE = new ResourceLocation(EEEABMobs.MOD_ID, "textures/entity/effect/immortal_magic_circle/power.png");
    private static final ResourceLocation HARMFUL_TEXTURE = new ResourceLocation(EEEABMobs.MOD_ID, "textures/entity/effect/immortal_magic_circle/harmful.png");
    private static final ResourceLocation BENEFICIAL_TEXTURE = new ResourceLocation(EEEABMobs.MOD_ID, "textures/entity/effect/immortal_magic_circle/beneficial.png");
    ...
    public void render(EntityImmortalMagicCircle entity, float entityYaw, float delta, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        VertexConsumer consumer = bufferIn.getBuffer(ModRenderType.getGlowingEffect(getTextureLocation(entity)));
