...
public class AnimationControllerScreen extends AbstractContainerScreen<AnimationControllerMenu> {
    ...
    public void render(@NotNull PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        animationIndexEdit.render(poseStack, mouseX, mouseY, partialTicks);
    ...
    protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
        this.font.draw(poseStack, this.chatComponent, this.imageWidth / 2F - this.font.width(this.chatComponent) / 2F, 6F, 4210752);
    }
    ...
    public void init() {
        ...
        playButton = new Button(this.leftPos + 17, this.topPos + 57, 46, 20, Component.literal("play"), e -> {
