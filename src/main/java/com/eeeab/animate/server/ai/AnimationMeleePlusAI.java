    ...
    public void tick() {
        ...
        if (target != null) {
            ...
            if (--this.delayCounter <= 0) {
                ...
                if (distSqr > Math.pow(this.attacker.getAttributeValue(Attributes.FOLLOW_RANGE), 2)) {
                    if (this.attacker.getNavigation().isDone() && !this.attacker.getNavigation().moveTo(target, 1)) {
